...
Destacamos aqui uma ideia apresentada por Roger Schank e Robert Abelson, na Conferência Conjunta Internacional sobre Inteligência Artificial, realizada em setembro de 1975, que ilustra a necessidade de um modelo destinado não mais a recuperar documentos ou traduzir referências, mas em a construir uma cadeia de significados que são inicialmente abstraídas de textos em linguagem natural, têm seus elementos principais armazenados e, posteriormente, recriar o texto a partir de ligações feitas entre esses elementos. Cabendo ao modelo selecionar o que é realmente relevante e o que precisa ser armazenado para a reconstrução da mensagem.
...
Além do desenvolvimento do MARGIE, conforme indica Will Fitzgerald [-@fitz1996], outros analisadores posteriores foram construídos na mesma tradição, incluindo ELI (Riesbeck & Schank 1976), SAM (Schank & Abelson 1977), PAM (Wilensky 1978) e FRUMP (DeJong 1979). Enquanto categorização, podemos agrupar os modelos desenvolvidos na década de 1970 em função do processamento de linguagem natural como uma _tarefa semântica_ [@fitz1996].

Na década de 1980, cresceu o foco colocado sobre a modelagem de memória e realização de inferência. Destacam-se os modelos de Memória Dinâmica de Schank (Schank 1982), IPP (Lebowitz 1980), BORIS (Dyer 1983), MOPTRANS (Lytinen 1984).
