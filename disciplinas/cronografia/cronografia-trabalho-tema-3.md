...
![Diferentes métodos de avaliação do SMART, apresenta os "Valores de recuperação e precisão para a solicitação _Equações diferentes_" - @salton1965](https://github.com/gabrielmacedo/ci/assets/20596966/d3d80803-eacc-4b4f-a1d2-492d38704065)
